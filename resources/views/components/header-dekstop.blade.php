                    ...
                    <div class="dropdown position-relative d-inline-block">
                        <a href="#" 
                           ...
                           onclick="event.preventDefault(); toggleDropdown(this)">
                            ...
                            <!-- User Name -->
                            <span class="fw-semibold text-dark ms-2">{{ Auth::user()->name }}</span> 

                            <i class="fa-solid fa-caret-down text-dark ms-2" id="dropdownIcon"></i>
                        </a>
                        ...
                        <ul class="dropdown-menu shadow position-absolute end-0 mt-2" id="userDropdownMenu">
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('user.chat') }}">
                                    <span><i class="fa-solid fa-envelope me-2"></i> Message to Admin</span>
                                    <livewire:user-notifications wire:poll.5s />
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('user.orders') }}">
                                    <i class="fa-solid fa-box me-2"></i> Order List
                                </a>
                            </li>
