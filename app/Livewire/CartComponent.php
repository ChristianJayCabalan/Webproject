    ...
    public function confirmOrder()
{
    ...
    // Validation only for barangay now
        $this->validate([
        ...
        $this->dispatch('swal', [
            'title' => 'Success!',
            'text'  => 'Order successfully placed! Please wait for admin approval.',
            'icon'  => 'success',
        ]);
    }
